...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/Andyvpn/newsc/main/ws-stunnel"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Andyvpn/newsc/main/issue.net"
